...
public class InstitutionController {
    ...
    public Institution getInstitutionByCNPJ(String cnpj) throws Exception{
        ...
        try(InstitutionDAO institutionDAO = new InstitutionDAO()){
            return institutionDAO.getInstitutionByCNPJ(cnpj);
        } catch (Exception e){
            System.out.println(e.getMessage());
            throw e;
        }
    ...
    public boolean isRegistered_Institution(ArrayList<String> institutionList, Institution institution, int i){
    ...
    public boolean isRegistered_CNPJ(ArrayList<String> cnpjList, Institution institution, int i){
        if (i >= cnpjList.size())
            return false;
