...
public class View extends BaseView{
    ...
    private Container requesterContainer(Institution institution) {
        ...
        requestContainer.add(super.createHeaderLabel("Solicitante", 178, 10, 251, 32));
        requestContainer.add(super.createInputLabel("Instituição: " + institution.getName(), 13, 52, 170, 30));
